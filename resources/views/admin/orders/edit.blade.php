                ...
                <div class="col-md-7 data_trek">
                    <div class="fon-cart-2">
                                    ...
                                    <select name="status" class="form-control my-bg-grey" required>
                                        @foreach($statuses as $status)
                                            <option value="{{$status->id}}"
                                                    @if ($status->id == $order->status) selected @endif>{{$status->status_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="clientName" value="{{$order->clientName}}"
                                       class="form-control my-bg-grey" id="inputName" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputTel" class="col-sm-4 col-form-label">Телефон</label>
                            <div class="col-sm-8">
                                <input type="tel" name="clientTel" value="{{$order->clientTel}}"
                                       class="form-control my-bg-grey" id="inputTel" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-4 col-form-label">E-mail</label>
                            <div class="col-sm-8">
                                <input type="email" name="clientEmail" class="form-control my-bg-grey"
                                       value="{{$order->clientEmail}}" id="inputEmail" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="clientCity" class="form-control my-bg-grey"
                                       value="{{$order->clientCity}}" id="inputCity" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputAddress" class="col-sm-4 col-form-label">Адрес</label>
                            <div class="col-sm-8">
                                <input type="text" name="clientAddress" class="form-control my-bg-grey"
                                       value="{{$order->clientAddress}}" id="inputAddress" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputComment" class="col-sm-4 col-form-label ">Комментарий к заказу</label>
                            <div class="col-sm-8">
                                <textarea class="form-control my-bg-grey" name="clientComment" id="inputComment"
                                          rows="5">{{$order->clientComment}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fon-cart-2 fon-cart-2-top">
                        ...
                        <label>
                            <input type="radio" name="type_pay" class="type_pay" value="nal"
                                   @if ($order->type_pay == 'nal') checked @endif>
                            <img src="/img/nal_pay.png">
                        </label>

                        <label>
                            <input type="radio" name="type_pay" class="type_pay" value="cart"
                                   @if ($order->type_pay == 'cart') checked @endif>
                            ...
                            <div class="CartItem row" data-autotest="CartItem">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class=""><input type="hidden"
                                                         :value="item.size">Размер: {{$item['attributes']['size_world']}}
                                        ({{$item['attributes']['size_rus']}})
                                    </div>
                                    <div class=""><input type="hidden"
                                                         :value="item.color">Цвет: {{$item['attributes']['color_name']}}
                                    </div>
                                    <div class=""><input type="hidden"
                                                         :value="item.quantity">Кол-во: {{$item['quantity']}}</div>
                                </div>
