    ...
    <div class="container">
        ...
        @if($category->parent_id)
            <div class="alert alert-warning"
                 role="alert">Внимание! У этой категории есть дочерние. При удалении и переносе, дочерние категории также будут изменены/удалены вслед за родительской.</div>
        @endif
        ...
        <form onsubmit="deleteCategory(this);return false;" action="{{route('admin.category.destroy', $category)}}"
              method="post">
            @csrf
            @method('DELETE')
