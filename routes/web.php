...
Route::get('/search', 'WelcomeController@search')->name('seach');
Route::post('/search', 'WelcomeController@search')->name('seach');
...
Route::group(['prefix' => 'panel', 'namespace' => 'panel', 'middleware' => ['permission:witness']], function () {
    Route::get('/', 'SOSController@index')->name('SOS');
    Route::get('/search-soscam', 'SOSController@search')->name('SOScam');
    Route::post('/search-soscam', 'SOSController@searchStore')->name('SOScam');
    Route::post('/search-soscam/{editID?}', 'SOSController@searchUpdate')->name('SOScam');
    Route::get('/search-soscam/{id}/edit', 'SOSController@searchEdit')->name('SOScam');
    Route::post('/have-soscam', 'SOSController@haveStore')->name('HaveSOScam');
    Route::get('/have-soscam', 'SOSController@have')->name('HaveSOScam');
    Route::post('/have-soscam/{editID?}', 'SOSController@haveUpdate')->name('HaveSOScam');
    Route::get('/have-soscam/{id}/edit', 'SOSController@haveEdit')->name('HaveSOScam');
    Route::get('/profile', 'SOSController@profile')->name('profile');
    Route::post('/profile', 'SOSController@profileUpdate')->name('profile');
    Route::post('/avatar', 'SOSController@avatar')->name('avatar');
});
...
Route::get('/google', 'DriveController@create_folder');
...
Route::get('put', function () {
    $bb = Storage::cloud()->put('test.txt', 'Hello World');
...
Route::get('put-existing', function () {
    ...
    $b = Storage::cloud()->put($filename, $fileData);
    return 'File was saved to Google Drive';
});
...
Route::get('newest', function () {
    ...
    Storage::cloud()->put($filename, Carbon::now()->toDateTimeString());
...
Route::get('share', function () {
    ...
    $hh = $service->permissions->create(
        $file['path'], $Permission, array('fields' => 'id', 'supportsTeamDrives' => true));
